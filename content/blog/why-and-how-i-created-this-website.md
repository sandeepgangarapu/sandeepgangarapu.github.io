...
Sites like Squarespace achieves the first but not the second, tools like GitHub pages ([academic pages theme](https://academicpages.github.io/)) do the vice versa. I use [Notion](https://www.notion.so/) because it achieves both. This is not the main selling point of Notion. Notion is more of a task organizer/note-taking tool.   
...
I had to do a one-time set up so that the notion directs the content to my custom nameserver and domain. That's where [FRUITION](https://fruitionsite.com/) comes in. Just follow the instructions on this page and you can have a website based on Notion in minutes. I use the icons from [The Noun Project](https://thenounproject.com/) to make everything on the website look clean.
